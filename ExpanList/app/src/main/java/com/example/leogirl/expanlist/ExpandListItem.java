...
public class ExpandListItem extends RelativeLayout{
    ...
    public ExpandListItem(Context context,AttributeSet attrs){

        super(context,attrs);
        init(context, attrs);
    }
    public ExpandListItem(Context context,AttributeSet attrs,int defStyle){
    ...
    private void init(final Context context,AttributeSet attrs){
        ...
        final View rootView = View.inflate(context,R.layout.content_main,this);
        headerLayout = (FrameLayout) rootView.findViewById(R.id.view_expandable_headerlayout);
        final TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.ExpanList);
        final int headerID = typedArray.getResourceId(R.styleable.ExpanList_el_headerLayout, -1);
        final int contentID = typedArray.getResourceId(R.styleable.ExpanList_el_contentLayout, -1);
        ...
        duration = typedArray.getInt(R.styleable.ExpanList_el_duration, getContext().getResources().getInteger(android.R.integer.config_shortAnimTime));
        final View headerView = View.inflate(context, headerID, null);
        headerView.setLayoutParams(new ViewGroup.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT));
        headerLayout.addView(headerView);
        setTag(ExpandListItem.class.getName());
        ...
        headerLayout.setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                return isOpaque() && event.getAction() == MotionEvent.ACTION_DOWN;
            }
        });
